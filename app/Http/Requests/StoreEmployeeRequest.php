...
class StoreEmployeeRequest extends FormRequest
{
    ...
    {
        return [
            'user_id' => 'required|integer|exists:users,user_id|unique:employees',
    ...
    public function messages()
    {
        return [
            ...
            'user_id.unique' => 'معرف المستخدم مستخدم بالفعل لموظف آخر',
            ...
            'hire_date.required' => 'حقل تاريخ التوظيف مطلوب',
