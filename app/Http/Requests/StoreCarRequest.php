...
class StoreCarRequest extends FormRequest
{
    ...
    {
        return [
            'inventory_id' => 'required|integer|exists:car_inventory,inventory_id',
            'car_name' => 'required|string|max:50|unique:cars',
            'model_year' => 'required|integer',
            'color' => 'required|string|max:20',
            'vin' => 'required|string|max:50|unique:cars',
            'seats' => 'required|in:2,4,5,6,12',
    ...
    {
        return [
            'inventory_id.required' => 'حقل معرف المخزون مطلوب',
            'inventory_id.integer' => 'يجب أن يكون معرف المخزون رقمًا صحيحًا',
            'inventory_id.exists' => 'معرف المخزون المحدد غير موجود',
            'car_name.required' => 'حقل اسم السيارة مطلوب',
            ...
            'model_year.required' => 'حقل سنة الموديل مطلوب',
            ...
            'vin.required' => 'حقل رقم التعريف (VIN) مطلوب',
            ...
            'seats.required' => 'حقل المقاعد مطلوب',
