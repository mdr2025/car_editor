...
class StoreCarEngineRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'engine_name' => 'required|string|max:50',
    ...
    public function messages()
    {
        return [
            ...
            'fuel_tank_capacity.required' => 'حقل سعة خزان الوقود مطلوب',
